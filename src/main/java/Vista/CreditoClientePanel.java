 ...
 * No contiene lógica de negocio: toda la lógica vive en CreditoClienteController.
...
public class CreditoClientePanel extends JPanel {
    ...
    private void initComponentes() {
        ...
        txtRuc.setBounds(190, 10, 130, 35);
        add(txtRuc);

        JLabel lblCliente = new JLabel("Cliente:");
        lblCliente.setFont(new Font("Tahoma", Font.BOLD, 16));
        lblCliente.setBounds(330, 15, 70, 25);
        add(lblCliente);
        ...
        txtNombreCliente.setBounds(400, 10, 200, 35);
        add(txtNombreCliente);

        btnVerHistorial = new JButton("Ver Historial");
        btnVerHistorial.setBounds(620, 15, 120, 30);
        add(btnVerHistorial);
        ...
        modeloProductos = new DefaultTableModel(
                new Object[][]{},
                new String[]{"ID", "Descripcion", "Cantidad", "Precio U.", "Precio Total"}
        ) {
            @Override
        ...
        tablaProductos.setFont(new Font("Tahoma", Font.PLAIN, 16));
        tablaProductos.getTableHeader().setReorderingAllowed(false);
        scrollProductos = new JScrollPane(tablaProductos);
        scrollProductos.setBounds(10, 120, 1020, 340);
        add(scrollProductos);

        JLabel lblTotal = new JLabel("Total:");
        lblTotal.setFont(new Font("Tahoma", Font.PLAIN, 16));
        lblTotal.setBounds(760, 480, 60, 30);
        add(lblTotal);

        lblTotalValor = new JLabel("-----");
        lblTotalValor.setFont(new Font("Tahoma", Font.PLAIN, 24));
        lblTotalValor.setBounds(830, 475, 150, 35);
        add(lblTotalValor);

        btnAceptar = new JButton("ACEPTAR");
        btnAceptar.setBounds(910, 475, 120, 40);
        add(btnAceptar);
    }

    // ---- getters usados por CreditoClienteController ----
    public JTextField getTxtRuc() { return txtRuc; }
