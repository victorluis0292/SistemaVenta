...
public class Productos {
    ...
    private int id_empresa; // NUEVO CAMPO

    public Productos() {
    }

    public Productos(int id, String codigo, String nombre, int proveedor, String proveedorPro,
                     int stock, double precio, double preciocompra, int id_empresa) {
        this.id = id;
        this.codigo = codigo;
        this.nombre = nombre;
        ...
        this.id_empresa = id_empresa; // Inicializamos
    }
    ...
    // NUEVOS getter y setter para id_empresa
