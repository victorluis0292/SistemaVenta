...
public final class Sistema extends javax.swing.JFrame {
   ...
   public String origenActual = "venta"; // valor inicial por defecto
    ...
    public Sistema() {
     ...
     public static Sistema getInstancia() {
        ...
        // Método para reiniciar (cerrar) la instancia y liberar memoria
  ...
  Estilos.estiloTablas(TableVenta);
    ...
    public void stateChanged(javax.swing.event.ChangeEvent evt) {
        ...
        if (selectedIndex == 2) {
            ...
            System.out.println("origenActual = credito");
              ...
              menuCorteCaja.aplicarEstilo(menu);
                menuCorteCaja.agregarBotonesAJPanel(jPanel15);
        ...
        //agregado al pantalla entrada Midate1
      ...
      //cliente  campos
        ...
        // este modelo 3 se recibe en table entrada
