...
import static Vista.OpcVentasDelTurno.instance;
...
private void cargarDatosRango(Date inicio, Date fin) {
    ...
    try {
        ...
        double totalSaldoInicial = cashDao.obtenerSaldoInicialRango(fechaInicioStr, fechaFinStr).doubleValue();
    ...
    try {
        switch (tipoReporte) {
            case "Día":
                ...
                totalSaldoInicial = cashDao.obtenerSaldoInicialDelDia().doubleValue();
            ...
            case "Semana":
                ...
                totalSaldoInicial = cashDao.obtenerSaldoInicialSemana(anioSemana, semana).doubleValue();
                totalEgresos = obtenerEgresosSemana(anioSemana, semana);
                ganancia = obtenerGananciaSemana(anioSemana, semana);
                break;
            ...
            case "Mes":
                ...
                totalSaldoInicial = cashDao.obtenerSaldoInicialMes(anioMes, mes).doubleValue();
                totalEgresos = obtenerEgresosMes(anioMes, mes);
                ganancia = obtenerGananciaMes(anioMes, mes);
                break;
            ...
            case "Año":
                ...
                totalSaldoInicial = cashDao.obtenerSaldoInicialAnio(anio).doubleValue();
                totalEgresos = obtenerEgresosAnio(anio);
                ganancia = obtenerGananciaAnio(anio);
                break;
        }
