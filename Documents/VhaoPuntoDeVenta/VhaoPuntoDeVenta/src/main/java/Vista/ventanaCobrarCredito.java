...
txtEliminarid.setText(dato+"");
    ...
    String valor = txtPaga1.getText().trim();
...
void EliminarID() {
    ...
    try {
        ...
        try {
            ...
            System.err.println("Error cerrando PreparedStatement: " + e);
        }
        try {
            if (con != null) con.close();
        } catch (Exception e) {
            System.err.println("Error cerrando Connection: " + e);
        }
    }
}
...
void Operacion() {
    try {
        ...
        String pagaText = txtPaga1.getText();
        ...
        if (pagaText == null || pagaText.isEmpty()) {
            lblcambio.setText("0.00");
            return;
        }
        ...
        lblcambio.setText(String.format("%.2f", resta));

    } catch (NumberFormatException e) {
        // En caso de que el texto no sea numérico válido
